...
const Login = () => {
  ...
  return (
    <Box minHeight="100vh" p={2} display="flex" flexDirection="column" justifyContent="center" gap={8}>
      <Typography fontSize={48} fontWeight={700} fontFamily="'Inknut Antiqua', serif" align="center" lineHeight={1.25}>
        Gangster <br /> Arena
      </Typography>
      <Box display="flex" flexDirection="column" gap={1}>
        ...
        <Box display="flex" alig nItems="center" justifyContent="center" gap={1}>
